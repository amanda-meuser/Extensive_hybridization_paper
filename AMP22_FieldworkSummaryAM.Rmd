...
dfFishes <- read.csv("Leuciscid_Metadata_Apr2023.csv")
library("ggplot2")
...
FishesSStable <- table("Species"=dfFishes2_SOI$Common_Name, "Site"=dfFishes2_SOI$Waterbody) # pull out just site and species names and put into table so that it calculates frequency at each site, for each species
