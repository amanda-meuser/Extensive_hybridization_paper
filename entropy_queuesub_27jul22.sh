...
ENTROPY="/project/def-emandevi/bin/entropy"
...
entropyrun="$ENTROPY -i $IN_FILE -l 150000 -b 125000 -t 25 -k $k -o $PREFIX\_k$k\_150k_rep$rep\_$SUFFIX.hdf5 -m 1 -w 0 -q $LDAK_FILE -Q 1 -r $RANDOM" # this line is printing our parameters to the log file
echo $entropyrun
$ENTROPY -i $IN_FILE -l 150000 -b 125000 -t 25 -k $k -o $PREFIX\_k$k\_150k_rep$rep\_$SUFFIX.hdf5 -m 1 -w 0 -q $LDAK_FILE -Q 1 -r $RANDOM # this is telling the computer what to do 
